...
public class AdministratorController {
	...
	@PostMapping
	public MessageResponse save (@RequestBody @ApiParam("api al parammetre ") Administrator administrator) {
		return administratorService.save(administrator);
		
	}
	@PutMapping
	public MessageResponse update(@RequestBody Administrator administrator) {
	...
	public MessageResponse changePassword(@RequestBody PasswordRequest passwordRequest) {
		return administratorService.changePassword(passwordRequest);
